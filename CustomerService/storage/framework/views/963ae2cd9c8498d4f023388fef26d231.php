    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between fixed h-full z-30">
        <div>
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="<?php echo e(route('admin.support.tickets.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 transition-all duration-300">
                ...
                <a href="<?php echo e(route('sla-reports.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg transition-all duration-300">
                ...
                <div x-data="{ notificationsOpen: false }" class="relative">
                    ...
                    <div x-show="notificationsOpen" @click.outside="notificationsOpen = false" x-transition class="absolute right-0 mt-2 w-[360px] bg-white border border-gray-200 rounded-xl shadow-2xl z-50 flex flex-col overflow-hidden" style="display: none;">
                        ...
                        <div class="p-3 bg-gray-50 border-t border-gray-100 text-center">
                            <a href="<?php echo e(route('admin.support.tickets.index')); ?>" class="w-full inline-flex items-center justify-center gap-2 py-2 border border-gray-200 rounded-lg text-xs font-semibold text-gray-700 bg-white hover:bg-gray-50 transition-all">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900 mt-1"><?php echo e($compliance->metric_value ?? '0'); ?>%</h3>
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900 mt-1"><?php echo e($response->metric_value ?? '0h'); ?></h3>
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900 mt-1"><?php echo e($resolution->metric_value ?? '0h'); ?></h3>
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900 mt-1"><?php echo e($overdueTickets); ?></h3>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mt-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <a href="<?php echo e(route('admin.support.tickets.index')); ?>" class="dash-card-hover flex items-center space-x-4 p-4 border border-gray-100 hover:border-blue-200 hover:bg-blue-50/30 rounded-xl transition-all group">
...
</html><?php /**PATH C:\Users\Aric\OneDrive\Documents\GitHub\CustomerService\CustomerService\resources\views/sla-reports/index.blade.php ENDPATH**/ ?>