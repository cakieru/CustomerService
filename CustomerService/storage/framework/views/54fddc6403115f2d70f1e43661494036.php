            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="animate-detail-reveal bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden" style="--panel-index: 1;">
                        ...
                        <div class="p-6 space-y-6 flex flex-col gap-4">
                            ...
                            <?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="flex gap-4 <?php echo e($msg->sender == 'Agent' ? 'flex-row-reverse' : ''); ?>">
                                        <div class="w-9 h-9 <?php echo e($msg->sender == 'Agent' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'); ?> font-semibold rounded-full flex-shrink-0 flex items-center justify-center text-sm shadow-sm">
                                            <?php echo e($msg->sender == 'Agent' ? 'AD' : 'CC'); ?>

                                        </div>
                                        <div class="space-y-1 flex-1 <?php echo e($msg->sender == 'Agent' ? 'text-right' : ''); ?>">
                                            <div class="flex items-baseline gap-2 <?php echo e($msg->sender == 'Agent' ? 'justify-end' : 'justify-between'); ?>">
                                                <h5 class="font-semibold text-sm text-gray-900"><?php echo e($msg->sender == 'Agent' ? 'Admin User' : 'Charlize Casama'); ?></h5>
                                                <span class="text-xs text-gray-400"><?php echo e(\Carbon\Carbon::parse($msg->sent_at)->format('g:i A')); ?></span>
                                            </div>
                                            <div class="inline-block p-4 rounded-xl text-sm leading-relaxed text-left shadow-sm <?php echo e($msg->sender == 'Agent' ? 'bg-blue-600 text-white border border-blue-700' : 'bg-gray-50 text-gray-700 border border-gray-100'); ?>">
                                                <?php echo e($msg->message); ?>
                        ...
                        <form action="<?php echo e(route('admin.support.tickets.reply', $ticket->id)); ?>" method="POST" class="...">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Administrator\Documents\GitHub\CustomerService\CustomerService\resources\views/admin/details.blade.php ENDPATH**/ ?>