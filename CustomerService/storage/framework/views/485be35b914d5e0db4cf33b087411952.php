...
<body class="bg-gray-50 text-gray-800 font-sans antialiased min-h-screen flex overflow-hidden">
    ...
    <aside class="w-16 sm:w-20 md:w-64 bg-white border-r border-gray-200 flex flex-col justify-between fixed h-full z-30 transition-all duration-300">
        <div>
            ...
            <nav class="p-2 md:p-4 space-y-1">
                ...
                <a href="<?php echo e(route('KnowledgeBase')); ?>" title="Knowledge Base" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg transition-all">
                ...
                <a href="<?php echo e(route('admin.support.reports')); ?>" title="SLA Reports" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 transition-all">
    ...
    const articles = <?php echo json_encode($articles, 15, 512) ?>;
    ...
    const workspaceContainer = document.getElementById('appWorkspaceContainer');
        ...
        window.handlePublishFormSubmit = function() {
            ...
            fetch("<?php echo e(route('kb.store')); ?>", {
                method: "POST",
                headers: {
...
</html><?php /**PATH C:\laragon\www\CustomerService\CustomerService\resources\views/KnowledgeBase.blade.php ENDPATH**/ ?>