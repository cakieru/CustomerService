...
<head>
    ...
    <title><?php echo e($title ?? 'Support Center - Customer Portal'); ?></title>
...
<body class="bg-[#fafafa] font-sans antialiased text-[#2d3748] min-h-screen flex flex-col justify-between selection:bg-blue-100">
    ...
    <header class="bg-white/80 backdrop-blur-md border-b border-gray-100 sticky top-0 z-50 transition-all duration-300">
        <div class="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <nav class="flex items-center space-x-8">
                ...
                <a href="<?php echo e(route('customer.tickets')); ?>" class="text-gray-500 hover:text-gray-800 font-medium text-sm transition-colors duration-300"></a> 
                <a href="<?php echo e(route('customer.create')); ?>" class="bg-[#0f62fe] hover:bg-[#0052cc] text-white font-semibold px-5 py-2.5 rounded-xl text-sm shadow-sm hover:shadow-md flex items-center space-x-1.5 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0">
    ...
    <main class="max-w-6xl mx-auto px-6 py-12 w-full flex-grow flex flex-col justify-between space-y-12">
        ...
        <div id="portalPillarCards" class="relative z-0 grid grid-cols-1 md:grid-cols-3 gap-6 opacity-0 animate-fade-in-up animation-delay-100 block">
            ...
            <div class="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                ...
                <a href="<?php echo e(route('customer.create')); ?>" class="text-[#0f62fe] font-semibold text-sm flex items-center space-x-1">
           ...
           <!-- Track My Tickets -->
            <a href="<?php echo e(route('customer.tickets')); ?>" class="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <div>
    ...
    <footer class="bg-white border-t border-gray-100 w-full mt-12">
        <div class="max-w-6xl mx-auto px-6 h-16 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-400 font-medium">
            <p>&copy; <?php echo e(date('Y')); ?> Support Center. All rights reserved.</p>
            <div class="flex space-x-6 mt-2 sm:mt-0">
                <a href="<?php echo e(route('admin.support.dashboard')); ?>" class="hover:text-gray-600 transition-colors duration-300">Agent Portal</a>
    ...
    <script>
        ...
        const articles = <?php echo e(\Illuminate\Support\Js::from($articles)); ?>;
...
</html><?php /**PATH C:\Users\Administrator\Documents\GitHub\CustomerService\CustomerService\resources\views/CustomerPortal.blade.php ENDPATH**/ ?>