...
<!-- Parin 8:47-->
    ...
    <div class="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav class="flex items-center space-x-4">
            <!-- Home Link -->
            <a href="<?php echo e(route('CustomerPortal')); ?>" class="text-gray-500 hover:text-gray-800 font-medium text-sm transition-colors duration-300">
                Home
            </a>
            
            <!-- Active Page Pill: My Tickets -->
            <a href="<?php echo e(route('customer.tickets')); ?>" class="bg-[#f0f4f8] text-[#0f4c81] font-semibold px-4 py-2 rounded-xl text-sm transition-all duration-300 hover:opacity-90">
                My Tickets
            </a>
    ...
    <main class="flex-grow flex flex-col justify-start py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto w-full">
        ...
        <div class="w-full" x-data="{ activeTab: 'all' }">
            ...
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    href="<?php echo e(route('customer.tickets.show', $ticket->id)); ?>" 
        ...
        <div class="flex items-center justify-between text-xs text-slate-400 border-t border-slate-200 pt-8 !mt-12">
            ...
            <div class="space-x-4">
                <a href="<?php echo e(route('admin.support.dashboard')); ?>" class="hover:underline">Agent Portal</a>
...
</html><?php /**PATH C:\Users\Administrator\Documents\GitHub\CustomerService\CustomerService\resources\views/customer/CustomerIndex.blade.php ENDPATH**/ ?>