    ...
    <header class="bg-white/80 backdrop-blur-md border-b border-gray-100 sticky top-0 z-50 transition-all duration-300">
        <div class="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <nav class="flex items-center space-x-8">
                <a href="<?php echo e(route('CustomerPortal')); ?>" class="text-gray-500 hover:text-gray-800 font-medium text-sm transition-colors duration-300">Home</a>
...
</html><?php /**PATH C:\laragon\www\CustomerService\CustomerService\resources\views/layouts/app.blade.php ENDPATH**/ ?>