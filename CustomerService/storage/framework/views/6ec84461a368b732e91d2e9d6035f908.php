    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between fixed h-full z-30">
        <div>
            ...
            <nav class="p-4 space-y-1">
                <a href="<?php echo e(route('admin.support.dashboard')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg transition-all duration-300">
                ...
                <a href="<?php echo e(route('sla-reports.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 transition-all duration-300">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col overflow-hidden">
                        ...
                        <div class="divide-y divide-gray-100 flex-1">
                            <?php $__empty_1 = true; $__currentLoopData = $recentTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <a href="<?php echo e(route('admin.support.tickets.show', $ticket->id)); ?>" class="dash-card-hover block px-6 py-4 hover:bg-gray-50 transition-colors">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col overflow-hidden">
                        ...
                        <div class="divide-y divide-gray-100 flex-1">
                            <?php $__empty_1 = true; $__currentLoopData = $slaAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <a href="<?php echo e(route('admin.support.tickets.show', $alert->id)); ?>" class="dash-card-hover flex px-6 py-4 space-x-4 hover:bg-gray-50 transition-colors">
...
</html><?php /**PATH C:\Users\Aric\OneDrive\Documents\GitHub\CustomerService\CustomerService\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>