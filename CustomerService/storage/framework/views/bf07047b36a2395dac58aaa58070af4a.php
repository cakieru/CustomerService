    ...
    <aside class="w-16 sm:w-20 md:w-64 bg-white border-r border-gray-200 flex flex-col justify-between fixed h-full z-30 transition-all duration-300">
        <div>
            ...
            <nav class="p-2 md:p-4 space-y-1">
                ...
                <a href="<?php echo e(route('agent')); ?>" title="Tickets" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg transition-all">
        ...
        <div class="p-2 md:p-4 border-t border-gray-100">
            <a href="<?php echo e(route('customer')); ?>" title="Customer Portal" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-purple-700 hover:bg-purple-50 rounded-lg transition-all">
