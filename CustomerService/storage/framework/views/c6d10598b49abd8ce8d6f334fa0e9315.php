            ...
            <div class="space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm flex flex-col">
                    ...
                    <div id="ticketTableBody" class="divide-y divide-gray-100 text-sm flex flex-col relative bg-white">
                        ...
                        <!-- TKT-1001 -->
                        <div class="ticket-row table-grid py-4 px-6 bg-white border-b border-gray-100 cursor-pointer" data-status="open" data-priority="high" data-url="<?php echo e(route('agent.ticket.details')); ?>" onclick="window.location=this.dataset.url">
                        ...
                        <!-- TKT-1002 -->
                        <div class="ticket-row table-grid py-4 px-6 bg-white border-b border-gray-100 cursor-pointer" data-status="in-progress" data-priority="medium" data-url="<?php echo e(route('agent.ticket.details')); ?>" onclick="window.location=this.dataset.url">
                        ...
                        <!-- TKT-1003 -->
                        <div class="ticket-row table-grid py-4 px-6 bg-white border-b border-gray-100 cursor-pointer" data-status="open" data-priority="medium" data-url="<?php echo e(route('agent.ticket.details')); ?>" onclick="window.location=this.dataset.url">
                        ...
                        <!-- TKT-1004 -->
                        <div class="ticket-row table-grid py-4 px-6 bg-white border-b border-gray-100 cursor-pointer" data-status="in-progress" data-priority="high" data-url="<?php echo e(route('agent.ticket.details')); ?>" onclick="window.location=this.dataset.url">
                        ...
                        <!-- TKT-1005 -->
                        <div class="ticket-row table-grid py-4 px-6 bg-white border-b border-gray-100 cursor-pointer" data-status="open" data-priority="critical" data-url="<?php echo e(route('agent.ticket.details')); ?>" onclick="window.location=this.dataset.url">
                        ...
                        <!-- TKT-1006 -->
                        <div class="ticket-row table-grid py-4 px-6 bg-white border-b border-gray-100 cursor-pointer" data-status="resolved" data-priority="medium" data-url="<?php echo e(route('agent.ticket.details')); ?>" onclick="window.location=this.dataset.url">
                        ...
                        <!-- TKT-1007 -->
                        <div class="ticket-row table-grid py-4 px-6 bg-white border-b border-gray-100 cursor-pointer" data-status="open" data-priority="low" data-url="<?php echo e(route('agent.ticket.details')); ?>" onclick="window.location=this.dataset.url">
                        ...
                        <!-- TKT-1008 -->
                        <div class="ticket-row table-grid py-4 px-6 bg-white border-b border-gray-100 cursor-pointer" data-status="closed" data-priority="high" data-url="<?php echo e(route('agent.ticket.details')); ?>" onclick="window.location=this.dataset.url">
...
</html><?php /**PATH C:\Users\Aric\OneDrive\Documents\GitHub\CustomerService\CustomerService\resources\views/agent.blade.php ENDPATH**/ ?>