    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between fixed h-full z-30">
        <div>
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="<?php echo e(route('KnowledgeBase')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg transition-all duration-300">
...
</html><?php /**PATH C:\Users\Aric\OneDrive\Documents\GitHub\CustomerService\CustomerService\resources\views/KnowledgeBase.blade.php ENDPATH**/ ?>