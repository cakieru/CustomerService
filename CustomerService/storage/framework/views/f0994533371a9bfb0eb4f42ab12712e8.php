...
<body class="bg-gray-50 text-gray-800 font-sans antialiased min-h-screen flex overflow-hidden">
    ...
    <aside class="w-16 sm:w-20 md:w-64 bg-white border-r border-gray-200 flex flex-col justify-between fixed h-full z-30 transition-all duration-300">
        <div>
            ...
            <nav class="p-2 md:p-4 space-y-1">
                <a href="<?php echo e(route('admin.support.dashboard')); ?>" title="Dashboard" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 transition-all">
                    <i data-lucide="layout-dashboard" class="w-5 h-5 flex-shrink-0"></i>
                    <span class="hidden md:inline whitespace-nowrap">Dashboard</span>
                </a>
                <a href="<?php echo e(route('agent')); ?>" title="Tickets" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 transition-all">
                    <i data-lucide="ticket" class="w-5 h-5 flex-shrink-0"></i>
                    <span class="hidden md:inline whitespace-nowrap">Tickets</span>
                </a>
                <a href="<?php echo e(route('KnowledgeBase')); ?>" title="Knowledge Base" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 transition-all">
                    <i data-lucide="book-open" class="w-5 h-5 flex-shrink-0"></i>
                    <span class="hidden md:inline whitespace-nowrap">Knowledge Base</span>
                </a>
                <a href="<?php echo e(route('sla-reports.index')); ?>" title="SLA Reports" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg transition-all">
                    <i data-lucide="bar-chart-3" class="w-5 h-5 text-blue-600 flex-shrink-0"></i>
                    <span class="hidden md:inline whitespace-nowrap">SLA Reports</span>
                </a>
            </nav>
        </div>
        <div class="p-2 md:p-4 border-t border-gray-100">
            <a href="<?php echo e(route('CustomerPortal')); ?>" title="Customer Portal" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-purple-700 hover:bg-purple-50 rounded-lg transition-all">
    ...
    <div class="flex-1 pl-16 sm:pl-20 md:pl-64 flex flex-col h-screen overflow-hidden relative w-full transition-all duration-300">
        ...
        <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-8 sticky top-0 z-20 flex-shrink-0">
            ...
            <div class="flex items-center gap-2 sm:gap-4">
                <div x-data="{ notificationsOpen: false }" class="relative">
                    ...
                    <div x-show="notificationsOpen" @click.outside="notificationsOpen = false" x-transition class="absolute right-0 mt-2 w-72 sm:w-[360px] bg-white border border-gray-200 rounded-xl shadow-2xl z-50 flex flex-col overflow-hidden" style="display: none;">
                        ...
                        <div class="max-h-[380px] overflow-y-auto divide-y divide-gray-100">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notify): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <a href="<?php echo e(route('admin.support.tickets.show', $notify->id)); ?>" class="p-4 hover:bg-gray-50 transition-all flex items-start gap-3 relative block">
                                    <div class="w-8 h-8 rounded-full bg-orange-100 text-orange-700 flex-shrink-0 flex items-center justify-center font-bold text-xs">
                                        <?php echo e(strtoupper(substr($notify->customer->name ?? 'C', 0, 2))); ?>

                                    </div>
                                    <div class="flex-1 pr-3">
                                        <p class="text-xs font-bold text-gray-900 truncate"><?php echo e($notify->subject ?? 'New Support Ticket'); ?></p>
                                        <p class="text-[11px] text-gray-500 mt-0.5"><span class="text-blue-600 font-semibold">#<?php echo e($notify->ticket_reference ?? 'TKT-'.$notify->id); ?></span> by <?php echo e($notify->customer->name ?? 'Guest'); ?></p>
                                        <span class="text-[10px] text-gray-400 block mt-1"><?php echo e($notify->created_at->diffForHumans()); ?></span>
                                    </div>
                        ...
                        <div class="p-3 bg-gray-50 border-t border-gray-100 text-center">
                            <a href="<?php echo e(route('agent')); ?>" class="w-full inline-flex items-center justify-center gap-2 py-2 border border-gray-200 rounded-lg text-xs font-semibold text-gray-700 bg-white hover:bg-gray-50 transition-all">
        ...
        <!-- MAIN CONTENT -->
        <main class="p-4 sm:p-8 flex-1 overflow-y-auto h-[calc(100vh-4rem)] hide-scrollbar">
            <div class="max-w-7xl w-full mx-auto space-y-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="relative self-start sm:self-auto">
                        ...
                        <div id="exportDropdown" class="export-dropdown">
                            <a href="<?php echo e(route('sla-reports.export', ['format' => 'csv'])); ?>" onclick="showToast('Exporting CSV...', 'success')">
                                <i data-lucide="file-spreadsheet" class="w-4 h-4 text-green-600"></i>
                                Export as CSV
                            </a>
                            <a href="<?php echo e(route('sla-reports.export', ['format' => 'json'])); ?>" onclick="showToast('Exporting JSON...', 'success')">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1"><?php echo e($compliance->metric_value ?? '0'); ?>%</h3>
                            <p class="text-xs text-gray-400 mt-1"><?php echo e($resolvedTickets); ?> resolved / <?php echo e($totalTickets); ?> total</p>
                        </div>
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1"><?php echo e($response->metric_value ?? '0h'); ?></h3>
                            <p class="text-xs text-gray-400 mt-1">Target: &lt; 2h</p>
                        </div>
                        <div class="h-12 w-12 bg-yellow-50 rounded-lg flex items-center justify-center text-yellow-500 flex-shrink-0">
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1"><?php echo e($resolution->metric_value ?? '0h'); ?></h3>
                            <p class="text-xs text-gray-400 mt-1">Target: &lt; 8h</p>
                        </div>
                        <div class="h-12 w-12 bg-purple-50 rounded-lg flex items-center justify-center text-purple-500 flex-shrink-0">
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1"><?php echo e($overdueTickets); ?></h3>
                            <p class="text-xs text-gray-400 mt-1"><?php echo e($openTickets); ?> open tickets</p>
                        </div>
                        <div class="h-12 w-12 bg-red-50 rounded-lg flex items-center justify-center text-red-500 flex-shrink-0">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-4 sm:p-6 relative">
                        ...
                        <div class="relative h-48" id="trendChartContainer">
                            <svg viewBox="0 0 600 180" class="w-full h-full" id="trendChart">
                                ...
                                <?php $__currentLoopData = $weeklyCompliance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <text x="<?php echo e(100 + ($index * 110)); ?>" y="175" text-anchor="middle" font-size="10" fill="#9ca3af"><?php echo e($week->week_name); ?></text>
                                ...
                                <polyline class="trend-line" points="<?php echo e(implode(' ', $compPoints)); ?>" fill="none" stroke="#3b82f6" stroke-width="2"/>
                                <?php $__currentLoopData = $weeklyCompliance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $x = 100 + ($index * 110);
                                    $compY = 140 - (($week->compliance_percentage / 100) * 120);
                                ?>
                                <circle class="chart-point" cx="<?php echo e($x); ?>" cy="<?php echo e($compY); ?>" r="4" fill="white" stroke="#3b82f6" stroke-width="2"
                                    data-week="<?php echo e($week->week_name); ?>" data-compliance="<?php echo e($week->compliance_percentage); ?>" data-ticket="<?php echo e($week->ticket_count); ?>" style="animation-delay: <?php echo e(0.8 + ($index * 0.1)); ?>s"/>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                <polyline class="trend-line" points="<?php echo e(implode(' ', $tktPoints)); ?>" fill="none" stroke="#a855f7" stroke-width="2" style="animation-delay: 0.3s"/>
                                <?php $__currentLoopData = $weeklyCompliance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $x = 100 + ($index * 110);
                                    $tktY = 140 - (($week->ticket_count / max($maxTickets, 1)) * 120);
                                ?>
                                <circle class="chart-point" cx="<?php echo e($x); ?>" cy="<?php echo e($tktY); ?>" r="4" fill="white" stroke="#a855f7" stroke-width="2"
                                    data-week="<?php echo e($week->week_name); ?>" data-compliance="<?php echo e($week->compliance_percentage); ?>" data-ticket="<?php echo e($week->ticket_count); ?>" style="animation-delay: <?php echo e(0.8 + ($index * 0.1)); ?>s"/>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </svg>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-4 sm:p-6 relative">
                        ...
                        <div class="relative h-48" id="priorityChartContainer">
                            <svg viewBox="0 0 600 150" class="w-full h-full" id="priorityChart">
                                ...
                                <?php $__currentLoopData = $priorityPerformance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $x = 90 + ($index * 120);
                                    $barColors = ['critical' => '#ef4444', 'high' => '#f97316', 'medium' => '#eab308', 'low' => '#22c55e'];
                                    $color = $barColors[strtolower($priority->priority_level)] ?? '#3b82f6';
                                ?>
                                <rect class="priority-bar" id="bar-<?php echo e(strtolower($priority->priority_level)); ?>" x="<?php echo e($x); ?>" y="130" width="60" height="0" fill="<?php echo e($color); ?>" rx="2"
                                    data-priority="<?php echo e($priority->priority_level); ?>" data-compliance="<?php echo e($priority->compliance_percentage); ?>"/>
                                <text x="<?php echo e($x + 30); ?>" y="145" text-anchor="middle" font-size="10" fill="#9ca3af"><?php echo e($priority->priority_level); ?></text>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </svg>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[720px]">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <?php $__currentLoopData = $slaTargets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $target): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($target->badge_color); ?> <?php echo e($target->badge_text_color); ?>">
                                            <?php echo e($target->priority_level); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($target->target_time); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($target->actual_time); ?></td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            <span class="text-sm font-medium text-gray-900"><?php echo e($target->compliance_percentage); ?>%</span>
                                            <div class="w-24 bg-gray-200 rounded-full h-2">
                                                <div class="<?php echo e($target->progress_color); ?> h-2 rounded-full transition-all duration-500" style="width: <?php echo e($target->compliance_percentage); ?>%"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($target->ticket_count); ?> tickets</td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center text-sm <?php echo e($target->status === 'On Track' ? 'text-green-600' : ($target->status === 'At Risk' ? 'text-yellow-600' : 'text-red-600')); ?>">
                                            <span class="w-2 h-2 <?php echo e($target->status === 'On Track' ? 'bg-green-500' : ($target->status === 'At Risk' ? 'bg-yellow-500' : 'bg-red-500')); ?> rounded-full mr-2"></span>
                                            <?php echo e($target->status); ?>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-4 sm:p-6 shadow-sm mt-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                        <a href="<?php echo e(route('agent')); ?>" class="dash-card-hover flex items-center space-x-4 p-4 border border-gray-100 hover:border-blue-200 hover:bg-blue-50/30 rounded-xl transition-all group">
                        ...
                        <a href="<?php echo e(route('KnowledgeBase')); ?>" class="dash-card-hover flex items-center space-x-4 p-4 border border-gray-100 hover:border-purple-200 hover:bg-purple-50/30 rounded-xl transition-all group">
                        ...
                        <a href="<?php echo e(route('admin.support.dashboard')); ?>" class="dash-card-hover flex items-center space-x-4 p-4 border border-gray-100 hover:border-green-200 hover:bg-green-50/30 rounded-xl transition-all group">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            <?php $__currentLoopData = $priorityPerformance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            animateBar('bar-<?php echo e(strtolower($priority->priority_level)); ?>', <?php echo e($priority->compliance_percentage); ?>, 800, <?php echo e(200 + ($index * 200)); ?>);
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        });
        ...
        const weekData = {
            <?php $__currentLoopData = $weeklyCompliance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            '<?php echo e($week->week_name); ?>': { compliance: <?php echo e($week->compliance_percentage); ?>, ticket: <?php echo e($week->ticket_count); ?> },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        };
        ...
        const priorityData = {
            <?php $__currentLoopData = $priorityPerformance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            '<?php echo e($priority->priority_level); ?>': <?php echo e($priority->compliance_percentage); ?>,
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        };
...
</html><?php /**PATH C:\laragon\www\CustomerService\CustomerService\resources\views/sla-reports/index.blade.php ENDPATH**/ ?>