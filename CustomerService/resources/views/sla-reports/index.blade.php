    ...
    <aside class="w-16 sm:w-20 md:w-64 bg-white border-r border-gray-200 flex flex-col justify-between fixed h-full z-30 transition-all duration-300">
        <div>
            ...
            <nav class="p-2 md:p-4 space-y-1">
                ...
                <a href="{{ route('sla-reports.index') }}" title="SLA Reports" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg transition-all">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1">{{ $response->metric_value ?? '0h' }}</h3>
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1">{{ $resolution->metric_value ?? '0h' }}</h3>
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1">{{ $overdueTickets }}</h3>
