                    ...
                    <div class="mt-5 pt-4 border-t border-gray-100">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @foreach($ticket->attachments as $attachment)
                                <a href="{{ asset('storage/' . $attachment->path) }}" target="_blank" class="inline-flex items-center gap-2 px-3 py-2 bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-200 rounded-lg text-xs text-gray-700 hover:text-blue-700 transition-colors group">
                                    ...
                                    <span class="truncate max-w-[140px] font-medium">{{ $attachment->filename }}</span>
