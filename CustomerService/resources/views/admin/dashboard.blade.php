    ...
    <aside class="w-16 sm:w-20 md:w-64 bg-white border-r border-gray-200 flex flex-col justify-between fixed h-full z-30 transition-all duration-300">
        <div>
            ...
            <nav class="p-2 md:p-4 space-y-1">
                <a href="{{ route('admin.support.dashboard') }}" title="Dashboard" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg transition-all">
                ...
                <a href="{{ route('sla-reports.index') }}" title="SLA Reports" class="flex items-center justify-center md:justify-start gap-3 px-3 py-3 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 transition-all">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1">{{ $summary['openTickets'] }}</h3>
                        </div>
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1">{{ $summary['inProgress'] }}</h3>
                        </div>
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1">{{ $summary['resolvedToday'] }}</h3>
                        </div>
                    ...
                    <div class="dash-card-hover bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mt-1">{{ $summary['criticalPriority'] }}</h3>
                        </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col overflow-hidden">
                        <div class="px-4 sm:px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50/50">
                            ...
                            <a href="{{ route('agent') }}" class="text-sm font-semibold text-blue-600 hover:underline">View all</a>
                        </div>
                        <div class="divide-y divide-gray-100 flex-1">
                            @forelse($recentTickets as $ticket)
                                <a href="{{ route('admin.support.tickets.show', $ticket->id) }}" class="dash-card-hover block px-4 sm:px-6 py-4 hover:bg-gray-50 transition-colors">
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                                        <div class="space-y-1">
                                            ...
                                            <p class="text-sm font-medium text-gray-900 truncate max-w-full sm:max-w-sm">{{ $ticket->subject }}</p>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col overflow-hidden">
                        <div class="px-4 sm:px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50/50">
                            ...
                            <span class="text-xs bg-red-100 text-red-800 font-bold px-2 py-1 rounded-full whitespace-nowrap">{{ count($slaAlerts) }} Breach Overdue</span>
                        </div>
                        <div class="divide-y divide-gray-100 flex-1">
                            @forelse($slaAlerts as $alert)
                                <a href="{{ route('admin.support.tickets.show', $alert->id) }}" class="dash-card-hover flex px-4 sm:px-6 py-4 space-x-4 hover:bg-gray-50 transition-colors">
